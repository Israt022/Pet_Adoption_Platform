...
SECRET_KEY = 'django-insecure-3ft=6lwwwq2u0w1$&$(rs-4du(#4!p!q*n*k+e3zj!ihu$z^ac'
...
# Configuration for django Cloudinary storage        
cloudinary.config( 
...
DJOSER = {
    ...
    'EMAIL_FRONTEND_SITE_NAME' : 'PetBond BD',
